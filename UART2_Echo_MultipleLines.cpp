...
void UART2_init (void)
{
    ...
    GPIOA->CRL &= 0xFFFFF0FF;   //clear the CNF2[1:0] and MODE2[1:0]
    GPIOA->CRL |= 0x0900;    //set PA_2 as: AF output push-pull, 10MHz
    ...
    GPIOA->ODR &= 0xFFFFFFF7;      //clear the bit ODR3 for PA_3
